...
{
      fmradio_configure_path((wm9093_fmvolume_enum)ucontrol->value.integer.value[0]);//20101222 inbang.park@lge.com Wake lock for  FM Radio //jungsoo1221.lee - P970 Merge
