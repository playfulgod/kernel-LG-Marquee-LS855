...
#define MAX17043_WORK_DELAY	(3 * HZ)	// 3s
...
//20110504 jikhwan.jeong@lge.com to calculate by more exact value.[Start] 
struct max17043_calibration_data {
	int voltage;	/* voltage in mA * 10000 */
	int capacity;	/* capacity in % */
	int gradient;	/* gradient * 1000 * 10000 */
	int intercept;	/* intercept * 1000 * 10000 */
};

// 180mA Load for Battery
static struct max17043_calibration_data without_charger[] = {
	{39537500,		81, 	88178,		32420017},
	{38000000,		58, 	68230,		34030225},
	{37400000,		40, 	32517,		36108108},
	{36950000,		20, 	22642,		36500418},
	{36012500,		4,		61005,		35738686},
	{33000000,		0,		548996, 	33548405},
	{ -1, -1, -1, -1},	// End of Data
};

// 770mA Charging Battery
static struct max17043_calibration_data with_charger[] = {
	{38650000,		2,		656202, 	37088955},
	{39562500,		19, 	56466,		38515672},
	{40212500,		46, 	23586,		39125236},
	{40887500,		61, 	45118,		38132688},
	{41587500,		71, 	65245,		36892722},
	{42007500,		100,	16284,		40419028},
	{ -1, -1, -1, -1},	// End of Data
};
...
#endif
//20110504 jikhwan.jeong@lge.com to calculate by more exact value.[End]
...
static int max17043_need_quickstart(int charging)
{
	...
	vol = vol * 10000;	//20110504 jikhwan.jeong@lge.com to calculate by more exact value.
...
static int max17043_next_alert_level(int level)
{
	if(level > 10)
		...
		return 0; /* Low Battery Power Down */
#endif
}
